...
intro: "Today if you're not testing your code, you're doing something wrong. After asking on Twitter I had a few requests for a tutorial on QUnit, so I wrote one. In this tutorial series we will be using QUnit as I work on a real life script I'm writing, a JavaScript wrapper for the Instagram API. We'll test as we go with QUnit and all the code is available for you to check out on Github. In this part I show you how to set up QUnit, write tests with it & how to test asynchronous function calls, too."
---
