...
intro: "A Publish & Subscribe implementation is a great way to organise your application. In this post I explain the benefits & how I've used the Pub/Sub pattern on a simple sample application, using jQuery. In the future we will be exploring this pattern further & looking at a plain JavaScript implementation. "
---
